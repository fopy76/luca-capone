        ...
        >
          <div className="flex flex-col items-center mb-10">
            <div className="w-32 h-32 md:w-36 md:h-36 rounded-full overflow-hidden shadow-md ring-2 ring-accent/30 mb-6">
              <Image
                src="/images/luca-profile.jpg"
                alt={`Portrait of Luca Capone, non-technical founder building AI products at ${AGE}`}
                width={180}
                height={180}
          ...
          <p className="text-[17px] text-text-secondary leading-[1.7] mb-8">
            If a {AGE}-year-old Italian guy with a full-time job, two kids, and zero CS background can build AI products in the margins of his life, what&apos;s your excuse? That&apos;s what Second-Act Builders is about. Welcome.
          </p>
